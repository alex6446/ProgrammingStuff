...
void ListNodeThemes () {
	NodeThemes.push_back({
		"Default",
		Color::Green, Color::Magenta, 14,				
		TerminusBold, Color::Black, Color::Black, 18
	});
	NodeThemes.push_back({
		"Sea",
		Color(74, 177, 157), Color::Magenta, 14,				// Node
		TerminusBold, Color(40, 92, 82), Color::Black, 18		// Text
	});
	NodeThemes.push_back({
		"Azul",
		Color(109, 215, 227), Color(155, 89, 182), 14,				// Node Color(155, 89, 182) Color(109, 215, 227)
		TerminusBold, Color(26, 122, 103), Color(79, 45, 92), 18		// Text Color(79, 45, 92) Color(26, 122, 103)
	});
}
...
void ListConnectionThemes () {
	ConnectionThemes.push_back({
		"Default",
		 Color::Magenta, Color::White, Color::Blue, 7, 				// Connection
		 TerminusBold, Color::White, Color::Blue, 16					// Text
	});
	ConnectionThemes.push_back({
		"Sea",
		 Color(239, 61, 89), Color(239, 238, 238), Color::Blue, 7, 	// Connection
		 TerminusBold, Color(239, 238, 238), Color::Blue, 16			// Text
	});
	ConnectionThemes.push_back({
		"Azul",
		 Color(52, 152, 219), Color(64, 98, 130), Color::Blue, 7, 	// Connection 
		 TerminusBold, Color(64, 98, 130), Color::Blue, 16			// Text
	});
	ConnectionThemes.push_back({
		"AzulLighter",
		 Color(52, 152, 219), Color(75, 113, 148), Color(123, 67, 148), 7, 	// Connection 
		 TerminusBold, Color(75, 113, 148), Color(123, 67, 148), 16			// Text Color(108, 60, 128)
	});
}
