...
class Main(tk.Frame):
	...
	def init_main(self):
		...
		input_box.place(x=2, y=0, width=246, height=120)
		...
		btnAC.place(x=2, y=122, width=60, height=60)
		btnScrt.place(x=64, y=122, width=60, height=60)
		btnPercent.place(x=126, y=122, width=60, height=60)
		btnDivide.place(x=188, y=122, width=60, height=60)
		btnMultiply.place(x=188, y=184, width=60, height=60)
		btnSubstract.place(x=188, y=246, width=60, height=60)
		btnAdd.place(x=188, y=308, width=60, height=60)
		btnEqual.place(x=188, y=370, width=60, height=60)
		btnDot.place(x=126, y=370, width=60, height=60)

		btn0.place(x=64, y=370, width=60, height=60)
		btn1.place(x=2, y=308, width=60, height=60)
		btn2.place(x=64, y=308, width=60, height=60)
		btn3.place(x=126, y=308, width=60, height=60)
		btn4.place(x=2, y=246, width=60, height=60)
		btn5.place(x=64, y=246, width=60, height=60)
		btn6.place(x=126, y=246, width=60, height=60)
		btn7.place(x=2, y=184, width=60, height=60)
		btn8.place(x=64, y=184, width=60, height=60)
		btn9.place(x=126, y=184, width=60, height=60)
