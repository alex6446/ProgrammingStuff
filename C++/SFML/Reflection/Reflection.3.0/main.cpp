...
int main () {
	...
	Surface.add_wall(Vector2f(700, 200), Vector2f(700, 600));
	Surface.add_wall(Vector2f(700, 600), Vector2f(500, 600));
	Surface.add_wall(Vector2f(500, 600), Vector2f(500, 200));*/
