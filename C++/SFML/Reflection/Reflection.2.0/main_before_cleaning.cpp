...
private:
	...
	void setBoundaries () {
		...
		/*Vector2f corner[4] = {
			Vector2f(10.f, 10.f),
			Vector2f(window->getSize().x-50, 30.f),
			Vector2f(window->getSize().x-10, window->getSize().y-10),
			Vector2f(50.f, window->getSize().y-30)
		};*/
		/*Vector2f corner[4] = {
			Vector2f(50.f, 30.f),
			Vector2f(window->getSize().x-10, 10.f),
			Vector2f(window->getSize().x-50, window->getSize().y-30),
			Vector2f(10.f, window->getSize().y-10)
		};*/
		Vector2f corner[4] = {
			Vector2f(-20.f, -20.f),
		...
		/*TemplateLine.cords[0] = Vertex(Vector2f(10.f, 10.f), boundariesColor);
		TemplateLine.cords[1] = Vertex(Vector2f(window->getSize().x-10, 10.f), boundariesColor);
		TemplateLine.angle = 0;
		boundaries.push_back(TemplateLine);
		TemplateLine.cords[0] = Vertex(Vector2f(window->getSize().x-10, window->getSize().y-10), boundariesColor);
		TemplateLine.cords[1] = Vertex(Vector2f(10.f, window->getSize().y-10), boundariesColor);
		TemplateLine.angle = 0;
		boundaries.push_back(TemplateLine);

		TemplateLine.cords[0] = Vertex(Vector2f(10.f, 10.f), boundariesColor);
		TemplateLine.cords[1] = Vertex(Vector2f(50.f, 190.f), boundariesColor);
		TemplateLine.angle = 102.5;
		boundaries.push_back(TemplateLine);
		TemplateLine.cords[0] = Vertex(Vector2f(50.f, 190.f), boundariesColor);
		TemplateLine.cords[1] = Vertex(Vector2f(50.f, 260.f), boundariesColor);
		TemplateLine.angle = 90;
		boundaries.push_back(TemplateLine);
		TemplateLine.cords[0] = Vertex(Vector2f(10.f, window->getSize().y-10), boundariesColor);
		TemplateLine.cords[1] = Vertex(Vector2f(50.f, 260.f), boundariesColor);
		TemplateLine.angle = 77.5;
		boundaries.push_back(TemplateLine);

		TemplateLine.cords[0] = Vertex(Vector2f(window->getSize().x-50, 190.f), boundariesColor);
		TemplateLine.cords[1] = Vertex(Vector2f(window->getSize().x-10, 10.f), boundariesColor);
		TemplateLine.angle = 77.5;
		boundaries.push_back(TemplateLine);
		TemplateLine.cords[0] = Vertex(Vector2f(window->getSize().x-50, 260.f), boundariesColor);
		TemplateLine.cords[1] = Vertex(Vector2f(window->getSize().x-10, window->getSize().y-10), boundariesColor);
		TemplateLine.angle = 102.5;
		boundaries.push_back(TemplateLine);
		TemplateLine.cords[0] = Vertex(Vector2f(window->getSize().x-50, 190.f), boundariesColor);
		TemplateLine.cords[1] = Vertex(Vector2f(window->getSize().x-50, 260.f), boundariesColor);
		TemplateLine.angle = 90;
		boundaries.push_back(TemplateLine);*/
		...
		/*
		TemplateLine.cords[0] = Vertex(Vector2f(90.f, 10.f), boundariesColor);
		TemplateLine.cords[1] = Vertex(Vector2f(window->getSize().x-90, 10.f), boundariesColor);
		TemplateLine.angle = 0;
		boundaries.push_back(TemplateLine);
		TemplateLine.cords[0] = Vertex(Vector2f(window->getSize().x-90, window->getSize().y-10), boundariesColor);
		TemplateLine.cords[1] = Vertex(Vector2f(90.f, window->getSize().y-10), boundariesColor);
		TemplateLine.angle = 0;
		boundaries.push_back(TemplateLine);
		...
		TemplateLine.angle = 90;
		boundaries.push_back(TemplateLine);
		TemplateLine.cords[0] = Vertex(Vector2f(90.f, window->getSize().y-10), boundariesColor);
		TemplateLine.cords[1] = Vertex(Vector2f(50.f, 260.f), boundariesColor);
		TemplateLine.angle = 102.5;
		boundaries.push_back(TemplateLine);
		...
		boundaries.push_back(TemplateLine);
		TemplateLine.cords[0] = Vertex(Vector2f(window->getSize().x-50, 260.f), boundariesColor);
		TemplateLine.cords[1] = Vertex(Vector2f(window->getSize().x-90, window->getSize().y-10), boundariesColor);
		TemplateLine.angle = 77.5;
		boundaries.push_back(TemplateLine);
		*/
	...
	float getAngle(float alpha, float beta) {
		...
		float endPositionAngle = 100.f;

		if (alpha > -1 && alpha <= 1)
			if (beta < 90)
				endPositionAngle = beta-alpha+beta;
			else 
				endPositionAngle = beta-alpha+beta;
		...
		cout << "beta: " << beta <<endl;
		cout << "beta-alpha+beta: " << beta-alpha+beta <<endl;
...
int main () {
	...
	// Window
	//RenderWindow window(VideoMode(640, 450), "Advanced Reflection");
	RenderWindow window(VideoMode(1080, 920), "Advanced Reflection");
	...
	//Surface.add_wall(Vector2f(170.f, 130.f), Vector2f(100.f, 330.f), Color::Green);
	//Surface.add_wall(Vector2f(170.f, 130.f), Vector2f(470.f, 130.f), Color::Green);
	//Surface.add_wall(Vector2f(470.f, 130.f), Vector2f(400.f, 330.f), Color::Green);
	
	//Surface.add_wall(Vector2f(370.f, 130.f), Vector2f(300.f, 330.f), Color::Green);
