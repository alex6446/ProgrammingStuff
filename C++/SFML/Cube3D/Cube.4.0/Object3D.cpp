...
Vector2f Object3D::getRotation () { return rotation; }
void Object3D::setRotation (Vector2f rotation) { updateRotation(rotation); }

void Object3D::rotate (Vector2f angle) { setRotation(rotation + angle); }
void Object3D::rotate (Vector2f angle, Vector3f point) {
...
Vector3f Object3D::convert_rotation (Vector3f position, Vector3f point, Vector2f angle) {
...
void Object3D::updateRotation (Vector2f rotation) {
	for (auto &i : vertexBuffer)
