...
{
	// Window
	RenderWindow window(VideoMode(640, 450), "Reflection Light");
	...
	while (window.isOpen()) {
		...
		/*console.add(std::to_string(angleWindow));*/
		/*console.add(std::to_string(180 - angleWindow));*/
		/*console.add(std::to_string(angleWindow + 180));*/
		/*console.add(std::to_string(360 - angleWindow));*/
		float x, y;
		float step;
		...
		if (angleTorch <= angleWindow  || angleTorch >= 360 - angleWindow) {
			...
			if (y <= step) {
				...
				console.print("Light angle: ");
				console.add(angleReflection);
